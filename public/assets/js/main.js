...
function setStatus(status) {
    ...
    if (status === "initializing") {
        ...
        showStatusImage(
            "https://i.pinimg.com/originals/d2/2a/47/d22a47fad2d210bf3e5a8e069bb68fb7.gif"
        );
    } else if (status === "Disconnect from server") {
        showStatusImage(
            "https://lordicon.com/icons/wired/lineal/2100-disconnect-network-offline.gif"
        );
    } else if (status === "pending") {
        showStatusImage(
            "https://media1.giphy.com/media/EZnSvdWR2k5jYljjp4/giphy.gif"
        );
    } else {
        hideStatusImage();
    }
